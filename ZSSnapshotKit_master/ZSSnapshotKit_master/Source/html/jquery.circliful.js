                ...
                if($(this).data('text') != undefined) {
					...
					if($(this).data('icon') != undefined) {
					 ...
					 if($(this).data('type') != undefined) {
						...
						$(this).append('<span class="circle-text">' + icon + text + '</span>');
						$(this).find('.circle-text').css({'line-height': (dimension * 0.75) + 'px', 'font-size' : size + 'px' });
					}
				...
				if($(this).data('info') != undefined) {
					...
					if($(this).data('type') != undefined) {
						...
						if(type == 'half') { 
							...
							$(this).find('.circle-info-half').css({'line-height': (dimension * 0.9) + 'px','font-size': (size * 2) + 'px'});
						} else {
							$(this).append('<span class="circle-info">' + info + '</span>');
							$(this).find('.circle-info').css({'line-height': (dimension * 1.25) + 'px','font-size': (size * 2) + 'px'});
						}
					} else {
						$(this).append('<span class="circle-info">' + info + '</span>');
						$(this).find('.circle-info').css({'line-height': (dimension * 1.25) + 'px','font-size': (size * 2) + 'px'});
